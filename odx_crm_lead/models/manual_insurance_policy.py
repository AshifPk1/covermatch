...
class ManualInsurancePremium(models.Model):
    _name = 'manual.insurance.premium'
    ...
    premium_product = fields.Many2one('product.product', "Plan Name", required=True)
    ...
    loss_dammage = fields.Boolean("Own Vehicle Loss or Damage")
    repaire_type = fields.Selection(
        [('agency', 'Agency Repair'), ('non_agency', 'Non Agency Repair')], string="Repaire Type")
    blood_money = fields.Selection(
        [('unlimited', 'Unlimited')], string="Third Party Bodily Injury")
    third_party_liability = fields.Selection(
        [('aed35', 'AED 3,500,000'), ('aed30', 'AED 3,000,000'), ('aed25', 'AED 2,500,000'),
         ('aed20', 'AED 2,000,000')], string="Third Party Property Damage")
    fire_theft = fields.Boolean("Fire And Cheft Cover")
    storm_flood = fields.Boolean("Valet Parking Damage and Theft")
    ...
    personal_belongigs = fields.Boolean("Loss Of Personal Belongings")
    oman_cover = fields.Selection(
        [('orange_card', 'Covered with orange card'), ('not_covered', 'Not Covered'),
         ('own_damage_only', 'Own Damage Only')], string="Oman Cover")
    ...
    driver_cover = fields.Boolean("Personal Accident Driver")
    passanger_cover = fields.Boolean("Personal Accident Passengers")
    rent_a_car = fields.Boolean("Rent A Car")
    ...
    excess_for_windscreen = fields.Boolean("Windscreen Damage")
    ...
    no_of_passengers = fields.Selection(
        [('upto14', 'Up To 14 Passengers'), ('upto26', 'Up To 26 Passengers'), ('upto56', 'Up To 56 Passengers')],
